...
HD_PWD='C:/vlsi3/vivado/best_fir/best_fir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log best_fir_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source best_fir_wrapper.tcl
