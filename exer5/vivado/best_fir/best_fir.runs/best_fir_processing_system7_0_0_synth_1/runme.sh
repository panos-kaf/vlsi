...
HD_PWD='C:/vlsi3/vivado/best_fir/best_fir.runs/best_fir_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log best_fir_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source best_fir_processing_system7_0_0.tcl
