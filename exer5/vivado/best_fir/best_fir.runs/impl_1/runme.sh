...
HD_PWD='C:/vlsi3/vivado/best_fir/best_fir.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log best_fir_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source best_fir_wrapper.tcl -notrace
