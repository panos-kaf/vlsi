...
#
# Generated by export_simulation on Fri Apr 11 11:44:20 +0300 2025
#
################################################################################
...
'-reset_run' switch to the './best_fir.sh' script.

./best_fir.sh -reset_run
...
./best_fir.sh -noclean_files

For more information on the script, please type './best_fir.sh -help'.
