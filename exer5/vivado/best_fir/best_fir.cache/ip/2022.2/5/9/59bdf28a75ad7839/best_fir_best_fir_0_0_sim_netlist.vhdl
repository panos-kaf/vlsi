...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  port (
    ...
    \slv_reg0_reg[7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  ...
  attribute SOFT_HLUTNM of valid_out_i_1 : label is "soft_lutpair0";
...
sleep_inv_i_1: unisim.vcomponents.LUT6
    generic map(
...
sleep_reg_inv: unisim.vcomponents.FDPE
     port map (
      C => best_fir_aclk,
      CE => '1',
      D => sleep_inv_i_1_n_0,
...
control_unit: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU
     port map (
      ...
      \slv_reg0_reg[7]\(7) => control_unit_n_9,
      \slv_reg0_reg[7]\(6) => control_unit_n_10,
      \slv_reg0_reg[7]\(5) => control_unit_n_11,
      \slv_reg0_reg[7]\(4) => control_unit_n_12,
      \slv_reg0_reg[7]\(3) => control_unit_n_13,
      \slv_reg0_reg[7]\(2) => control_unit_n_14,
      \slv_reg0_reg[7]\(1) => control_unit_n_15,
      \slv_reg0_reg[7]\(0) => control_unit_n_16,
      valid_to_we => valid_to_we
    );
...
ram_unit: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM
     port map (
      D(7) => control_unit_n_9,
      D(6) => control_unit_n_10,
      D(5) => control_unit_n_11,
      D(4) => control_unit_n_12,
      D(3) => control_unit_n_13,
      D(2) => control_unit_n_14,
      D(1) => control_unit_n_15,
      D(0) => control_unit_n_16,
      E(0) => valid_to_we,
