...
HD_PWD='C:/vlsi3/vivado/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_fir_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_fir_wrapper.tcl
