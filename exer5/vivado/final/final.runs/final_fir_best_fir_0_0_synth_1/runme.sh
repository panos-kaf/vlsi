...
HD_PWD='C:/vlsi3/vivado/final/final.runs/final_fir_best_fir_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_fir_best_fir_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_fir_best_fir_0_0.tcl
