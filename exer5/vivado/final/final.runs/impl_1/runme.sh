...
HD_PWD='C:/vlsi3/vivado/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_fir_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_fir_wrapper.tcl -notrace
