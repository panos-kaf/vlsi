...
#
# Generated by Vivado on Tue May 06 12:34:28 EEST 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/panos/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/home/panos/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_7 $vlogan_opts +v2k +incdir+"/home/panos/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/panos/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../exer7.gen/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/panos/dev/vlsi/vivado/exer7/exer7.cache/compile_simlib/vcs"
  fi
