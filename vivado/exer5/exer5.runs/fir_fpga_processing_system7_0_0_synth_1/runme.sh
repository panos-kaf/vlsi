...
HD_PWD='/home/user/vlsi/vivado/exer5/exer5.runs/fir_fpga_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_fpga_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_fpga_processing_system7_0_0.tcl
