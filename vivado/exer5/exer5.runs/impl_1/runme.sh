...
HD_PWD='/home/user/vlsi/vivado/exer5/exer5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_fpga_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_fpga_wrapper.tcl -notrace
