...
HD_PWD='/home/user/vlsi/vivado/exer5/exer4.runs/fir_fpga_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_fpga_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_fpga_processing_system7_0_1.tcl
